...
export default function Login() {
  ...
  useEffect(() => {
    // If auth finished loading and user is authenticated, redirect to main page
        ...
        <div className="login-right-content">
          <header className="login-right-header" style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            ...
            >
              {theme === 'light' ? (
                // Moon icon
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"></path></svg>
              ) : (
                // Sun icon
